...
function _init()
	add(actors,actor_base:new(0,0))
	add(actors,actor_paddle:new(20,20,1))
--  game.level=1
--  paddleadd(0,60,0)
--  paddleadd(120,60,1)
end
...
function actor_paddle:new (a,x,y,player)
   a = a or actor_base:new(a,x,y)
   setmetatable(a, self)
   self.__index = self
